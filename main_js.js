...
//производит вычисления, заменяя операнды и последующие за ними операции на результат выполнения
...
//5
//обрабатываются нажатие на кнопки конкретных классов
...
//7
//реагирует на нажатие и запускает clickHander
